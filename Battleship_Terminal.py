...
class Battleship():
    ...
    def grid(self):
        ...
        -If you wish to see the grid again type in "Grid"

        -If you wish to end the game type in "End"
    ...
    def ship_placement(self):
      ...
      carrier_ship_one = "C1" #random.choices(a) #input("Please type in the grid number where you would like to place the Carrier ship: ")
      carrier_ship_two = "D1" #input("Please type in the grid number where you would like to place the Carrier ship: ")
      carrier_ship_three = "E1" #input("Please type in the grid number where you would like to place the Carrier ship: ")
      carrier_ship_four = "F1" #input("Please type in the grid number where you would like to place the Carrier ship: ")
      carrier_ship_five = "G1" #input("Please type in the grid number where you would like to place the Carrier ship: ")
      battleship_carrier = {}

      battleship_one = "B5" #input("Please type in the grid number where you would like to place the Battleship: ")
      battleship_two = "C5" #input("Please type in the grid number where you would like to place the Battleship: ")
      battleship_three = "D5" #input("Please type in the grid number where you would like to place the Battleship: ")
      battleship_four = "E5" #input("Please type in the grid number where you would like to place the Battleship: ")
      battleship_BS = {}

      cruiser_one = "B10" #input("Please type in the grid number where you would like to place the Cruiser ship: ")
      cruiser_two = "C10" #input("Please type in the grid number where you would like to place the Cruiser ship: ")
      cruiser_three = "D10" #input("Please type in the grid number where you would like to place the Cruiser ship: ")
      battleship_cruiser = {}

      submarine_one = "J4" #input("Please type in the grid number where you would like to place the Submarine: ")
      submarine_two = "J5" #input("Please type in the grid number where you would like to place the Submarine: ")
      submarine_three = "J6" #input("Please type in the grid number where you would like to place the Submarine: ")
      battleship_submarine = {}

      destroyer_one = "I7" #input("Please type in the grid number where you would like to place the Destroyer: ")
      destroyer_two = "E8" #input("Please type in the grid number where you would like to place the Destroyer: ")
